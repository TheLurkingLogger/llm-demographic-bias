...
def main():
    ...
    for i, dataset in enumerate(datasets):
        ...
        print(f"Calculating human agreement for {dataset} - max label: {dataset_max_label} - method: {method}")
        mean_correlation, ci = calculate_human_agreement(data_dir, dataset_max_label, method)
